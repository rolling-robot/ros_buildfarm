...
from ros_buildfarm.arch_prereq_job import configure_arch_prereq_jobs


def main(argv=sys.argv[1:]):
    parser = argparse.ArgumentParser(
        description="Generate the 'Arch prerequisites' jobs on Jenkins")
    ...
    return configure_arch_prereq_jobs(
